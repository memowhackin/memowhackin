 ...
 *   .uizze/critique/<timestamp>__<slug>.md
...
import { getCritiqueDir } from "./lib/uizze-paths.mjs";
...
export function writeSnapshot({
  ...
  // UIZZE_CRITIQUE_META env var) could clobber them, leaving the
...
function main(argv) {
  ...
  switch (cmd) {
    ...
    case "write": {
      ...
      let meta = {};
      const metaArg = process.env.UIZZE_CRITIQUE_META;
      if (metaArg) {
        try {
