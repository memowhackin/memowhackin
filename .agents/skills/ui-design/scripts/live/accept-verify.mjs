...
const FORBIDDEN = [
  {
    marker: "uizze-variants-start",
    why: "variant wrapper comment left in source",
  },
  {
    marker: "uizze-variants-end",
    why: "variant wrapper comment left in source",
  },
  {
    marker: "uizze-carbonize-start",
    why: "carbonize block not rewritten into permanent form",
  },
  {
    marker: "uizze-carbonize-end",
    why: "carbonize block not rewritten into permanent form",
  },
  {
    marker: "uizze-param-values",
