#!/usr/bin/env node
/**
 * Context-signals gatherer for the bare Uizze invocation
 ...
 *   - critique:  the latest cached critique score (.uizze/critique)
...
// .uizze/, issue #303), a build artifact, or a dependency. Mirrors the
