...
**CRITICAL**: If no design system exists, do not create one yet. Ask only when the answer cannot be inferred safely, then wait. Understand the preferred location and structure first.
