---
name: uizze-manual-edit-applier
codex-name: uizze_manual_edit_applier
description: Applies leased Uizze live manual copy-edit batches to source and returns canonical Apply results.
...
22. Never copy browser/runtime scaffolding into source: no `contenteditable`, `data-uizze-*`, variant wrappers, live markers, generated browser attrs, `<style>`, `<script>`, or comments from the live UI.
