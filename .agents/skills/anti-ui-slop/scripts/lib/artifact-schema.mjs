/**
 * Schema versions for the artifacts Uizze writes, plus the readers and
...
/** `.uizze/design.json`, as documented in reference/document.md Step 4b. */
...
/**
 * Headings Uizze used to read and no longer does, with the reason. The
...
export function productStampLine(version = PRODUCT_SCHEMA_VERSION) {
  return `<!-- uizze:product-schema ${version} -->`;
}
