 ...
 * session's `uizze-variants-start` marker). They had two near-identical
 ...
 *
 * `.uizze` is the critical entry, and it is not cosmetic. Progressive
 * publication stages each revision as `.uizze/live/artifacts/
